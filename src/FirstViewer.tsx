    ...
    return (
        <main className="mt-[2.5em] mx-auto mb-[calc(100vw/4)] md:mb-[2.5em]">
            <div className="py-[2.5em] px-[1em] md:p-[2.5em]">
                {selectQuiz.length === 0 &&
                    <div className="w-[clamp(15rem,100%,50rem)] mt-[0] mx-auto mb-[3.5rem] text-[1rem] leading-[1.8] md:w-[clamp(240px,100%,800px)] md:mb-[56px] md:text-center md:tracking-[0.15em]">
                        <h1 className="text-[clamp(1.125rem,calc(100vw/20),2.5rem)] text-center bg-[#747474] text-[#fff] rounded rounded-b-none rounded-l-none md:text-[clamp(18px,calc(100vw/20),40px]">─ 誰でも100点!? 俺TUEEE ─</h1>
